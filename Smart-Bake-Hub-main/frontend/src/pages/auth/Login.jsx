...
import { Lock, Mail, ChevronRight, User, Shield, Briefcase, ArrowLeft, Eye, EyeOff } from 'lucide-react';
            ...
            <div className="w-full lg:w-[55%] flex flex-col relative z-10 min-h-[50vh] lg:min-h-screen px-8 pb-8 pt-4 lg:px-16 lg:pb-16 lg:pt-8">
                ...
                <div className="max-w-lg mb-8 relative z-20">
                    ...
                    <p className="text-[15px] text-[#4A3C31]/85 font-light leading-relaxed max-w-sm">
                        Welcome to Smart Bake Hub. Scan, order and enjoy delicious bakery items, meals, beverages and cakes with a smart self-service experience.
                    </p>
                </div>
            </div>
                ...
                <div className="w-full max-w-[420px] bg-[#FFFCF9] rounded-[40px] shadow-[0_20px_40px_rgba(74,60,49,0.05)] p-10 lg:p-12 relative z-20 border border-white animate-float-3d">
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        <div className="space-y-4">
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <User className="h-5 w-5 text-gray-400 group-focus-within:text-[#A67B5B] transition-colors" strokeWidth={1.5} />
                                </div>
                                <input
                                    type="email" required
                        ...
                        <div className="flex items-center justify-end pt-1 mb-6">
                            <a href="#" className="text-xs font-semibold text-[#A67B5B] hover:text-[#8c5e35] transition-colors">Forgot Password?</a>
                        </div>

                        <button
                            type="submit"
                            className="w-full flex justify-center py-4 px-4 text-sm font-semibold rounded-xl text-white bg-[#3D291F] hover:bg-[#2E1A12] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#3D291F] transition-all duration-300 shadow-md hover:shadow-lg"
                        >
                            Login
                        </button>
                    </form>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-sm text-gray-500">
                            ...
                            <Link to="/register" className="font-semibold text-[#A67B5B] hover:text-[#8c5e35] transition-colors">
                                Sign Up
                            </Link>
                        </p>
                    </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-100 text-center">
                        <Link to="/admin/login" className="text-xs font-semibold text-gray-400 hover:text-[#A67B5B] transition-colors flex items-center justify-center gap-1">
